# Hi, I'm Mayank Dinesh Mehta 👋

### M.Eng. Automation & IT | Industrial Automation | Machine Learning | Signal Processing

I'm a Master's student in **Automation & IT** at TH Köln, Germany, with a Bachelor's background in **Instrumentation & Control Engineering**.
...
🔗 [View Project](https://github.com/Mayank07-Git/non-intrusive-load-monitoring)
...
🔗 [View Project](https://github.com/Mayank07-Git/electricity-load-forecasting)
...
🔗 [View Project](https://github.com/Mayank07-Git/morse-code-decoder)
...
`Siemens TIA Portal` · `PLC` · `SCADA` · `Industrial IoT` · `Process Instrumentation`

**Programming & Data**

`Python` · `C/C++` · `SQL` · `Git` · `Jupyter`

**Machine Learning**

`Scikit-learn` · `LightGBM` · `Random Forest` · `Feature Engineering`

**Signal Processing**

`NumPy` · `SciPy` · `FFT` · `Digital Signal Processing`

**Data & Visualization**

`Pandas` · `Matplotlib` · `Grafana` · `Node-RED`
